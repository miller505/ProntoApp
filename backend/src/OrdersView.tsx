          ...
          return (
            ...
            >
              ...
              <div className="mb-3 space-y-2">
                <div className="text-xs text-gray-600 bg-gray-50 p-2 rounded-lg flex items-start gap-2">
                  <Icons.MapPin
                    size={14}
                ...
                <div className="flex justify-between items-center text-xs px-1">
                  <span className="text-gray-500 font-medium flex items-center gap-1">
                    <Icons.CreditCard size={12} /> Método de pago:
                  </span>
                  <Badge
                    color={o.paymentMethod === "CARD" ? "blue" : "green"}
              ...
              <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden mt-4 shadow-inner relative">
                <div
